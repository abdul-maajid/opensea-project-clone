        ...
        <div className={style.contentWrapper}>
          <div className={style.copyContainer}>
            ...
            <div className={style.description}>
              Opensea is the world &pos; s first and largest NFT marketplace
            </div>
          ...
          <div className={style.cardContainer}>
            ...
            <div className={style.infoContainer}>
              <img
                ...
                src="https://lh3.googleusercontent.com/a-/AOh14GhMxeuBTB8UryjRA5OgwbJDwp8H-7lsIMYuMGnc1Q=s83-c-mo"
              />
              <div className={style.author}>
                <div className={style.name}>Abdul Maajid</div>
                <a
